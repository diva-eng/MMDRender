...
{
	unsigned int	i;
	unsigned int	ulNumKeyFrame = pMotionData->ulNumKeyFrames;
...
{
	unsigned int	i;
	unsigned int	ulNumKeyFrame = pFaceData->ulNumKeyFrames;
...
#pragma mark ---
float cMotionPlayer::getCurrentFrame() {
	return m_fFrame;
}
void cMotionPlayer::clearCurrentFrame() {
	m_fOldFrame = m_fFrame= 0.0f;
}