...
// 初期化
//========
bool cPMDRigidBody::initialize( const PMD_RigidBody *pPMDRigidBody, cPMDBone *pBone, cBulletPhysics *bulletPhysics )
{
    // p_g_
	...
	if([[NSString stringWithCString:pBone->getName() encoding:NSShiftJISStringEncoding] isEqualToString:@"センター"]) 
